...
\item {Fabrication d'un pantographe avec un moteur (on a remarqué que le moteur permettait un tracé plus fluide et qui ressemblait au plotter notament dans l'observation des points des lignes)}
