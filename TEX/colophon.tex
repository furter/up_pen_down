...
* Git est un logiciel de gestion de versions décentralisé. Nous travaillons
...
* Github est la plateforme web qui permet d'éviter d'utiliser son propre
...
* Turtle, de quoi faire du Logo et back to the future.

* ConTeXt est un outil de mise en page et de composition typographique.
...
* FontForge est le principal et archétypal éditeur libre de fontes. On
l'aime comme une.

* Inkscape, éditeur vectoriel pico bello.

* Gimp, éditeur d'images quand besoin.
