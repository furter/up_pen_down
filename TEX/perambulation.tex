...
\logosssb {La recherche d'un contenu à produire qui parlerait directement de l'outil nous a conduit vers la page test d'impression du plotter Roland, disponible dans la machine.
