...
\stopquotation
 \logosssb {http://en.wikipedia.org/wiki/Turtle_graphics]}
   \page
\section {Article Pyramide Diapason Roue Crantée \crlf numéro 3 «Seymour et la Turtle»}
\page
...
\setuplayout[ 
        ...
        rightmargin=-30mm,
        footer=0mm,
        header=30mm, % removes header
        grid=yes, % activates baseline grid
        ]

\stopalignment
   \page
   \externalfigure [../IMAGES/tortue/2.jpg] [width=14cm] 
  \externalfigure [../IMAGES/tortue/3.jpg] [width=14cm]  \page
  \externalfigure [../IMAGES/tortue/4.jpg] [width=14cm] \page
  \externalfigure [../IMAGES/tortue/5.jpg] [width=14cm] \page
  \externalfigure [../IMAGES/tortue/7.jpg] [width=14cm] \page
  \externalfigure [../IMAGES/tortue/8.jpg] [width=14cm]  \page
  \externalfigure [../IMAGES/tortue/9.jpg] [width=14cm]  \page
  \externalfigure [../IMAGES/tortue/10.jpg] [width=14cm]  \page
  \externalfigure [../IMAGES/tortue/11.jpg] [width=14cm]  \page
  \externalfigure [../IMAGES/tortue/12.jpg] [width=14cm]  \page
  \externalfigure [../IMAGES/tortue/13.jpg] [width=14cm]  \page
  \externalfigure [../IMAGES/tortue/14.jpg] [width=14cm]  \page
  \externalfigure [../IMAGES/tortue/15.jpg] [width=14cm]  \page
  \externalfigure [../IMAGES/tortue/16.jpg] [width=14cm]  \page
   \externalfigure [../IMAGES/tortue/18.jpg] [width=14cm]  \page
  \externalfigure [../IMAGES/tortue/19.jpg] [width=14cm]  \page
\page
...
À travers notre expérimentation du langage, c'est une version augmentée de la Turlte que l'on met ainsi à l'exercice.} \blank
	...
	\page
          \externalfigure [../IMAGES/ARC/photos/Image 3.png][width=6cm]
                  \logosssb {Affiche pour la performance dans le hall.}
...
\externalfigure [../IMAGES/ARC/photos/Tentative restitution 1.jpg][width=9cm] \blank 
\logosssb {Tentative de première restitution entre les deux sessions.} \blank  
\page
\stopalignment
\stopcolumns               
\chapter{No Feature}
...
Le projet vise à rassembler des énergies autour d'objets typographiques, quels que soient leur avancement. Les typographies sont partagées de préférence au format UFO, et publiées sous licence libre, invitant les utilisateurs à modifier ou enrichir les projets. \crlf \crlf \crlf

Cet espace est ouvert à tous les étudiants de l'école, aux anciens étudiants ainsi qu'aux professeurs.
Les fichiers de travail sont rassemblés dans un dépôt git.}
\page
...
\externalfigure [../IMAGES/poster/poster2.jpeg][width=8cm] \blank 
\logosssb {Affiche pour le workshop \crlf de la quatrième session.} \blank
\page
