...
* FontForge, le principal et archétypal éditeur libre de fontes. Le texte et les titres de cette édition sont composés en Logo; Caractère dessiné à l'aide de FontForge et Turtle, pour ce workshop.
...
* TexShop, parce que la plupart d'entre nous édite ses fichiers TeX sur
Mac. Mais la compilation intégrée, entre autres, est fort problématique.

* Chiplotle, pour lancer le tracage par notre Roland, plotter table
traçante.}
\page
<<<<<<< HEAD
...
Atelier des étudiants en 4\high{e} année Design Graphique à Valence
\column
Alexandra Rio, Alice Jauneau, Anaïs Alauzen, Camille Chatelaine, David Vallance, Éléonore Jasseny, Gwenaël Fradin, Jordane Cals, Lorène Ceccon, Margot Baran et Vincent Duché, avec Open Source Publishing Alexandre Leray, Eric Schrijver, Femke Snelting, Gijs De Heij, John Haltiwanger, Ludi Loiseau, Pierre Huyghebaert,
Pierre Marchand, Stéphanie Vilayphiou.}
=======
\setupinterlinespace[12pt]
\logosssb {Workshop  OSP \crlf Up Pen Down \crlf  octobre 2012 — janvier 2013

Atelier des étudiants \crlf en 4\high{e} année \crlf Design Graphique \crlf à Valence
\column (Alexandra Rio, Alice \crlf Jauneau, Anaïs Alauzen, \crlf Camille Chatelaine, \crlf
