...
\citations{The turtle has three attributes:\crlf
	1.	a location\crlf
...
\logoregularitalique{\useURL[lien : http://en.wikipedia.org/wiki/Turtle_graphics]}
...
\blank
  ...
  \externalfigure [../IMAGES/ARC/photos/Image 5.png]\blank
       ...
       \externalfigure [../IMAGES/ARC/photos/Image 11.png]\blank
         1\high{re} session. Appropriation des outils dans l'espace. \blank
...
Les fichiers de travail sont rassemblés dans un dépôt git. Le site github.com fonctionne comme hébergeur. Un mode d’emploi pour collaborer en utilisant ces outils est à venir.\blank
\stopalignment
     ...
     Page de la fonderie de No-Feature qui réunit toutes les productions typographiques.
         ...
         \stopcolumns
          ...
          Page de droite, blog en ligne de collecte des pistes de travail pour la 3\high{e} session.
